...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        physical_items_total = self.lineitems.filter(
        ...
        print(
            f"All total: {self.order_total} | "
            f"Physical total: {physical_items_total} | "
            f"Delivery: {self.delivery_cost}"
        )
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        if self.product:
            ...
            return (
                f'Course {self.course.title} on order '
                f'{self.order.order_number}'
            )
        return (
            f'Item on order {self.order.order_number}'
        )
